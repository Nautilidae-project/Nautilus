...
"")
        ...
        self.frInformacoes.setGeometry(QtCore.QRect(130, 77, 741, 681))
...
"}")
        ...
        self.leCEP_2 = QtWidgets.QLineEdit(self.frInformacoes)
        self.leCEP_2.setGeometry(QtCore.QRect(170, 510, 450, 30))
        font = QtGui.QFont()
        font.setFamily("Roboto Slab")
        font.setPointSize(12)
        self.leCEP_2.setFont(font)
        self.leCEP_2.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.leCEP_2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.leCEP_2.setStyleSheet("")
        self.leCEP_2.setInputMethodHints(QtCore.Qt.ImhNone)
        self.leCEP_2.setInputMask("")
        self.leCEP_2.setText("")
        self.leCEP_2.setFrame(True)
        self.leCEP_2.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.leCEP_2.setAlignment(QtCore.Qt.AlignCenter)
        self.leCEP_2.setObjectName("leCEP_2")
        self.lbCEP_2 = QtWidgets.QLabel(self.frInformacoes)
        self.lbCEP_2.setGeometry(QtCore.QRect(110, 510, 81, 30))
        self.lbCEP_2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lbCEP_2.setStyleSheet("")
        self.lbCEP_2.setAlignment(QtCore.Qt.AlignCenter)
...
"}")
        ...
        self.frEsquerda.setGeometry(QtCore.QRect(110, 107, 80, 620))
        ...
        self.frDireita.setGeometry(QtCore.QRect(810, 107, 80, 620))
        ...
        self.lbCadastroTexto.setGeometry(QtCore.QRect(300, 10, 400, 111))
        font = QtGui.QFont()
        font.setFamily("Fira Sans")
...
"}")
    ...
    def retranslateUi(self, mwCadastro):
        ...
        self.leCEP_2.setPlaceholderText(_translate("mwCadastro", "Cidade"))
        self.lbCEP_2.setText(_translate("mwCadastro", "Cidade"))
