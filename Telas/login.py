...
"    background-color: qlineargradient(spread:pad, x1:0, y1:0.477, x2:0.852, y2:0.5, stop:0 rgba(18, 23, 38, 150), stop:1 rgba(255, 255, 255, 150));\n"
"}\n"
"\n"
"#pbarProgress{\n"
...
"}")
        ...
        self.frBordaIretaveisLogin.setFrameShape(QtWidgets.QFrame.NoFrame)
...
"")
        ...
        self.pbarProgress = QtWidgets.QProgressBar(self.pgLogin)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pbarProgress.sizePolicy().hasHeightForWidth())
        self.pbarProgress.setSizePolicy(sizePolicy)
        self.pbarProgress.setMinimumSize(QtCore.QSize(150, 15))
        self.pbarProgress.setMaximumSize(QtCore.QSize(500, 15))
        self.pbarProgress.setProperty("value", 24)
        self.pbarProgress.setFormat("")
        self.pbarProgress.setObjectName("pbarProgress")
        self.gridLayout_8.addWidget(self.pbarProgress, 1, 3, 1, 1)
