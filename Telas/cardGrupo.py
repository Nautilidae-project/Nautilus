...
# Form implementation generated from reading ui file 'cardGrupo-copia.ui'
#
...
"}")
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.pbExcluir)
