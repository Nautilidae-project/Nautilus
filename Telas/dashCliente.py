...
"")
        ...
        self.pbAddGrupo.setGeometry(QtCore.QRect(140, 240, 131, 41))
        self.pbAddGrupo.setStyleSheet("background-color: rgb(83, 162, 193);")
        self.pbAddGrupo.setObjectName("pbAddGrupo")
        self.label = QtWidgets.QLabel(self.frFormarGRupos)
        self.label.setGeometry(QtCore.QRect(40, 90, 91, 31))
        self.label.setStyleSheet("color: rgb(255, 255, 255);")
        self.label.setObjectName("label")
        self.leTituloGrupo = QtWidgets.QLineEdit(self.frFormarGRupos)
        self.leTituloGrupo.setGeometry(QtCore.QRect(150, 90, 211, 25))
        self.leTituloGrupo.setObjectName("leTituloGrupo")
        self.leDescricaoGrupo = QtWidgets.QLineEdit(self.frFormarGRupos)
        self.leDescricaoGrupo.setGeometry(QtCore.QRect(150, 140, 211, 25))
        self.leDescricaoGrupo.setObjectName("leDescricaoGrupo")
        self.label_2 = QtWidgets.QLabel(self.frFormarGRupos)
    ...
    def retranslateUi(self, wdgCliente):
        ...
        self.pbAddGrupo.setText(_translate("wdgCliente", "Adicionar Card"))
        self.label.setText(_translate("wdgCliente", "Titulo"))
        self.label_2.setText(_translate("wdgCliente", "Descrição"))
