...
"")
        ...
        self.frSearch.setMaximumSize(QtCore.QSize(150, 60))
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.frClientsList)
        ...
        self.verticalLayout_4.addWidget(self.tblClientes)
