...
"}")
        ...
        self.gridLayout_4.addWidget(self.frRightButtons, 1, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frCmbFilter, 1, 2, 1, 1)
        ...
        self.frListButtons1 = QtWidgets.QFrame(self.tbInfosCliente)
        self.frListButtons1.setMinimumSize(QtCore.QSize(0, 60))
        self.frListButtons1.setMaximumSize(QtCore.QSize(16777215, 60))
        self.frListButtons1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frListButtons1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frListButtons1.setObjectName("frListButtons1")
        self.gridLayout_41 = QtWidgets.QGridLayout(self.frListButtons1)
        self.gridLayout_41.setObjectName("gridLayout_41")
        self.frNomeTabela1 = QtWidgets.QFrame(self.frListButtons1)
        self.frNomeTabela1.setMinimumSize(QtCore.QSize(190, 0))
        self.frNomeTabela1.setMaximumSize(QtCore.QSize(200, 16777215))
        self.frNomeTabela1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frNomeTabela1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frNomeTabela1.setObjectName("frNomeTabela1")
        self.horizontalLayout_41 = QtWidgets.QHBoxLayout(self.frNomeTabela1)
        self.horizontalLayout_41.setObjectName("horizontalLayout_41")
        self.lbNomeTabela1 = QtWidgets.QLabel(self.frNomeTabela1)
        self.lbNomeTabela1.setMinimumSize(QtCore.QSize(180, 30))
        self.lbNomeTabela1.setMaximumSize(QtCore.QSize(180, 16777215))
        self.lbNomeTabela1.setAlignment(QtCore.Qt.AlignCenter)
        self.lbNomeTabela1.setObjectName("lbNomeTabela1")
        self.horizontalLayout_41.addWidget(self.lbNomeTabela1)
        self.gridLayout_41.addWidget(self.frNomeTabela1, 0, 0, 1, 1)
        self.frRightButtons2 = QtWidgets.QFrame(self.frListButtons1)
        self.frRightButtons2.setMinimumSize(QtCore.QSize(100, 0))
        self.frRightButtons2.setMaximumSize(QtCore.QSize(160, 60))
        self.frRightButtons2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frRightButtons2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frRightButtons2.setObjectName("frRightButtons2")
        self.horizontalLayout_192 = QtWidgets.QHBoxLayout(self.frRightButtons2)
        self.horizontalLayout_192.setObjectName("horizontalLayout_192")
        self.frRightButtons3 = QtWidgets.QFrame(self.frRightButtons2)
        self.frRightButtons3.setMaximumSize(QtCore.QSize(16777215, 60))
        self.frRightButtons3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frRightButtons3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frRightButtons3.setObjectName("frRightButtons3")
        self.horizontalLayout_193 = QtWidgets.QHBoxLayout(self.frRightButtons3)
        self.horizontalLayout_193.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_193.setSpacing(16)
        self.horizontalLayout_193.setObjectName("horizontalLayout_193")
        self.pbFuncionalidade11 = QtWidgets.QPushButton(self.frRightButtons3)
        self.pbFuncionalidade11.setObjectName("pbFuncionalidade11")
        self.horizontalLayout_193.addWidget(self.pbFuncionalidade11)
        self.pbFuncionalidade21 = QtWidgets.QPushButton(self.frRightButtons3)
        self.pbFuncionalidade21.setObjectName("pbFuncionalidade21")
        self.horizontalLayout_193.addWidget(self.pbFuncionalidade21)
        self.horizontalLayout_192.addWidget(self.frRightButtons3)
        self.gridLayout_41.addWidget(self.frRightButtons2, 0, 3, 1, 1)
        self.frCmbFilter1 = QtWidgets.QFrame(self.frListButtons1)
        self.frCmbFilter1.setMinimumSize(QtCore.QSize(140, 0))
        self.frCmbFilter1.setMaximumSize(QtCore.QSize(140, 60))
        self.frCmbFilter1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frCmbFilter1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frCmbFilter1.setObjectName("frCmbFilter1")
        self.horizontalLayout_181 = QtWidgets.QHBoxLayout(self.frCmbFilter1)
        self.horizontalLayout_181.setObjectName("horizontalLayout_181")
        self.comboBox1 = QtWidgets.QComboBox(self.frCmbFilter1)
        self.comboBox1.setMaximumSize(QtCore.QSize(140, 16777215))
        self.comboBox1.setObjectName("comboBox1")
        self.horizontalLayout_181.addWidget(self.comboBox1)
        self.gridLayout_41.addWidget(self.frCmbFilter1, 0, 2, 1, 1)
        self.frSearch = QtWidgets.QFrame(self.frListButtons1)
        ...
        self.gridLayout_41.addWidget(self.frSearch, 0, 1, 1, 1)
        self.gridLayout_3.addWidget(self.frListButtons1, 1, 0, 1, 2)
        self.frTopTabMenu1 = QtWidgets.QFrame(self.tbInfosCliente)
        self.frTopTabMenu1.setMinimumSize(QtCore.QSize(0, 90))
        self.frTopTabMenu1.setMaximumSize(QtCore.QSize(16777215, 110))
        self.frTopTabMenu1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frTopTabMenu1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frTopTabMenu1.setObjectName("frTopTabMenu1")
        self.horizontalLayout_21 = QtWidgets.QHBoxLayout(self.frTopTabMenu1)
        self.horizontalLayout_21.setContentsMargins(9, 0, 0, 0)
        self.horizontalLayout_21.setSpacing(24)
        self.horizontalLayout_21.setObjectName("horizontalLayout_21")
        self.frCard1 = QtWidgets.QFrame(self.frTopTabMenu1)
        self.frCard1.setStyleSheet("background-color: rgb(239, 41, 41);")
        self.frCard1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frCard1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frCard1.setObjectName("frCard1")
        self.label = QtWidgets.QLabel(self.frCard1)
        self.label.setGeometry(QtCore.QRect(0, 10, 181, 71))
        self.label.setStyleSheet("color: rgb(255, 255, 255);")
        self.label.setObjectName("label")
        self.horizontalLayout_21.addWidget(self.frCard1)
        self.frCard2 = QtWidgets.QFrame(self.frTopTabMenu1)
        self.frCard2.setStyleSheet("background-color: rgb(138, 226, 52);")
        self.frCard2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frCard2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frCard2.setObjectName("frCard2")
        self.label_2 = QtWidgets.QLabel(self.frCard2)
        self.label_2.setGeometry(QtCore.QRect(30, 10, 161, 71))
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_21.addWidget(self.frCard2)
        self.frCard3 = QtWidgets.QFrame(self.frTopTabMenu1)
        self.frCard3.setStyleSheet("background-color: rgb(252, 233, 79);")
        self.frCard3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frCard3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frCard3.setObjectName("frCard3")
        self.label_3 = QtWidgets.QLabel(self.frCard3)
        self.label_3.setGeometry(QtCore.QRect(20, 10, 151, 61))
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_21.addWidget(self.frCard3)
        self.frCard4 = QtWidgets.QFrame(self.frTopTabMenu1)
        self.frCard4.setStyleSheet("background-color: rgb(52, 101, 164);")
        self.frCard4.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frCard4.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frCard4.setObjectName("frCard4")
        self.label_4 = QtWidgets.QLabel(self.frCard4)
        self.label_4.setGeometry(QtCore.QRect(30, 20, 151, 51))
        self.label_4.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_21.addWidget(self.frCard4)
        self.gridLayout_3.addWidget(self.frTopTabMenu1, 0, 0, 1, 2)
    ...
    def retranslateUi(self, wdgCliente):
        ...
        self.lbNomeTabela1.setText(_translate("wdgCliente", "Todos os clientes"))
        self.pbFuncionalidade11.setText(_translate("wdgCliente", "Função 1"))
        self.pbFuncionalidade21.setText(_translate("wdgCliente", "Função 2"))
        ...
        self.label_2.setText(_translate("wdgCliente", "<html><head/><body><p>Clientes Inativos/</p><p>Clientes Totais</p></body></html>"))
        self.label_3.setText(_translate("wdgCliente", "<html><head/><body><p>Compromissos</p><p>da Semana</p></body></html>"))
        self.label_4.setText(_translate("wdgCliente", "Novos Clientes"))
